...
<div class="flex flex-row -mt-4 justify-end mr-4">
    <div
        class="bg-olive w-10 h-10 rounded-b-lg p-2 text-cocoa"
    ...
    <div
        class="bg-olive mx-4 w-10 h-10 rounded-b-lg p-2 text-cocoa"
    ...
    {#if isPostActive}
        <div class="bg-olive mr-4 w-10 h-10 rounded-b-lg p-2 text-cocoa" on:click={deactivate} on:keydown={deactivate}>
            <FaUserSlash />
        </div>
    {:else}
        <div class="bg-olive mr-4 w-10 h-10 rounded-b-lg p-2 text-cocoa" on:click={activate} on:keydown={activate}>
            <FaUserCheck />
        </div>
    {/if}
    <div class="bg-olive w-10 h-10 rounded-b-lg p-2 text-cocoa" on:click={deletePost} on:keydown={deletePost}>
        <MdDelete />
    </div>
</div>
